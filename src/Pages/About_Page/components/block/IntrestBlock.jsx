...
const IntrestBlock = () => {
  return (
    <div className="flex flex-col flex-1 md:flex-row gap-10 md:gap-20 md:pt-20 ">
      <div className=" flex flex-1">
        <img src={abt5} alt="" />
      </div>

      <div className=" flex flex-1 flex-col gap-10 md:py-10  md:px-10 font-sans">
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-3">
            <p className=" font-medium text-[1.25rem]">Other interests</p>
            <p className=" text-sm ">
          ...
          <p className="flex items-center text-sm border-b w-44 border-black">
        ...
        <div className="flex flex-col gap-3">
          <p className=" font-medium text-[1.25rem] ">Other goals</p>
          <div>
