...
const Hamburger = () => {
  ...
  return (
    <div className="md:hidden absolute">
      <ul className="flex flex-col justify-start items-start w-[80vw] border-t-2 border-blue-500 font-medium px-5 mx-12 gap-4 py-2 text-gray-500 text-md  bg-white">
